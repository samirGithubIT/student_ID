    ...
    <div class="row">
        <div class="col-10 m-auto mt-5 py-4">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ url("lists/update/$user->id") }}" method="post">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="grade" name="grade" value="{{ $user->grade ??  old('grade') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="father_name" name="father_name" value="{{ $user->father_name ??  old('father_name') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="mother_name" name="mother_name" value="{{ $user->mother_name ??  old('mother_name') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="address" name="address" value="{{ $user->address ??  old('address') }}"> </textarea>
                          </div>
                        <div class="mb-3">
